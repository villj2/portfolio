...
function fusion_get_portfolio_excerpt_length( $page_id = '' ) {
	...
	if ( 'excerpt' === fusion_get_option( 'portfolio_content_length', 'portfolio_content_length', $page_id ) ) {
		...
		if ( fusion_get_page_option( 'portfolio_excerpt', $page_id ) ) {
			...
			$excerpt_length = fusion_library()->get_option( 'excerpt_length_portfolio' );
		}
	} elseif ( ! $page_id && 'Excerpt' === fusion_library()->get_option( 'portfolio_content_length' ) ) {
		$excerpt_length = fusion_library()->get_option( 'excerpt_length_portfolio' );
	}
