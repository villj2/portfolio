	...
	function get_sharingbox_social_links_array( $args ) {
		...
		if ( Avada()->settings->get( 'sharing_linkedin' ) ) {
			$social_links_array['linkedin'] = array(
				'url'        => 'https://www.linkedin.com/shareArticle?mini=true&url=' . $args['link'] . '&amp;title=' . rawurlencode( $args['title'] ) . '&amp;summary=' . rawurlencode( html_entity_decode( $args['description'], ENT_QUOTES, 'UTF-8' ) ),
			);
		}
